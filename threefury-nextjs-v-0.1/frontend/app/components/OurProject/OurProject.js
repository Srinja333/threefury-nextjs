              ...
              <div id="carouselExampleCaptions" className=" carousel slide" data-bs-ride="carousel">
                  ...
                  <div className="ttext carousel-inner">
                      <div className="carousel-item active">
                          <Image src={pic1} width={720} height={341.625} alt="" />
                          <div className="carousel-caption d-md-block t_color">
                              <h5>College website</h5>
                          </div>
                      </div>
                      <div className="carousel-item">
                          <Image src={pic2} width={720} height={341.625} alt="" />
                          <div className="carousel-caption  d-md-block t_color">
                              <h5>Learning Management System</h5>
                          </div>
                      </div>
                      <div className="carousel-item">
                          <Image src={pic3} width={720} height={341.625} alt="" />
                          <div className="carousel-caption  d-md-block t_color">
                              <h5>Ecommerce book store</h5>
                          </div>
                      </div>
                      <div className="carousel-item">
                          <Image src={pic4} width={720} height={341.625} alt="" />
                          <div className="carousel-caption  d-md-block t_color">
                              <h5>Live Chat app</h5>
                          </div>
                      </div>
                      <div className="carousel-item">
                          <Image src={pic5} width={720} height={341.625} alt="" />
                          <div className="carousel-caption  d-md-block t_color">
                              <h5>Travel Website</h5>
                          </div>
                      </div>
                      <div className="carousel-item">
                          <Image src={pic6} width={720} height={341.625} alt="" />
                          <div className="carousel-caption  d-md-block t_color">
